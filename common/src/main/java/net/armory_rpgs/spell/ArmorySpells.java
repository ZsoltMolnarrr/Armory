...
public class ArmorySpells {
    ...
    private static Entry improved_arcane_beam() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_arcane_beam");
    ...
    private static Entry improved_arcane_barrage() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_arcane_barrage");
    ...
    private static Entry improved_meteor() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_meteor");
    ...
    private static Entry improved_firestorm() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_firestorm");
    ...
    private static Entry improved_frost_shield() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_frost_shield");
    ...
    private static Entry improved_ice_lance() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_ice_lance");
    ...
    private static Entry improved_circle_of_healing() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_circle_of_healing");
    ...
    private static Entry improved_penance() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_penance");
    ...
    private static Entry improved_divine_protection() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_divine_protection");
    ...
    private static Entry improved_judgement() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_judgement");
    ...
    private static Entry improved_shadow_step() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_shadow_step");
    ...
    private static Entry improved_bear_trap() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_bear_trap");
    ...
    private static Entry improved_charge() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_charge");
    ...
    private static Entry improved_shout() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_shout");
    ...
    private static Entry improved_barrage() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_barrage");
    ...
    private static Entry improved_spirit_wolf() {
        var id = new Identifier(ArmoryMod.NAMESPACE, "improved_spirit_wolf");
